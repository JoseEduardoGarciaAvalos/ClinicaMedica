                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                      <div class="form-group">
                          ...
                          <div class="input-group margin-bottom-sm">
                              ...
                              <input autocomplete="off" autofocus placeholder="Nombre de la madre del Paciente..." minlength="3" onkeypress="return soloLetras(event)" onpaste="return false"  class="form-control" type="text" name="nombre_madre_p" required value="{{old('nombre de la madre del paciente')}}" onkeyup="vNom(this)">
                           </div>
                      </div>
                </div>
                      ...
                      <div class="form-group">
                            ...
                            <div class="input-group margin-bottom-sm">
                             <span class="input-group-addon"><i class="fa fa-male fa-fw"></i></span>
                              <input  autocomplete="off" autofocus placeholder="Nombre del padre del Paciente..." minlength="3" onkeypress="return soloLetras(event)" onpaste="return false"  class="form-control" type="text" name="nombre_padre_p" required value="{{old('nombre del padre del paciente')}}" onkeyup="vNom(this)">
                          </div>
                      </div>
                </div>
